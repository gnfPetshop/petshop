...
<head lang="en">
    ...
    <link rel="stylesheet" href="static/css/dog_area-page2.css">
    <title></title>
</head>
<body>
    ...
    <div class="dog_area  mx-auto pt-5 row m-0">
        ...
        <div class="my_page">
            <ul class="pagination d-flex" id="page">
                <li id="page_prev"><a data-toggle="turn" href="dog_area.jsp">上一页</a></li>
                <li id="page1" ><a data-toggle="turn" href="dog_area.jsp">1</a></li>
                <li id="page2" class="checkbox"><a class="active"  data-toggle="turn" href="javascript:;">2</a></li>
