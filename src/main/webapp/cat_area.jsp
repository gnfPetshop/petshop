...
<head lang="en">
    ...
    <link rel="stylesheet" href="static/css/cat_area.css">
...
<div class="container-fluid px-0">
    ...
    <div class="collapse d-lg-none" id="content">
        <div>
            <ul>
                <li><a href="login.jsp">登录</a><a href="regist.html">注册</a></li>
                <li><a href="index.jsp">首页</a></li>
                <li><a href="dog_area.jsp">狗狗专区</a></li>
                <li><a href="cat_area.jsp">猫咪专区</a></li>
                <li><a href="zs_area.jsp">主食专区</a></li>
    ...
    <div class="row d-lg-none d-block" id="menu">
        <ul class="list-unstyled text-center">
            <li class="col-12 active" id="L1">猫咪专区</li>
            <li class="col-12" id="L2"><a href="#">猫咪主粮</a></li>
            <li class="col-12" id="L3"><a href="#">猫咪日用</a></li>
        </ul>
    </div>
    <!--主体内容区域-->
    <div class="dog_area  mx-auto pt-5 row m-0">
        ...
        <div class="main_left col-lg-3 d-lg-block d-none px-0">
            <div>
                <div class="style1"><img src="img/other/y.png"><span>猫咪专区</span></div>
                <ul class="list-unstyled mt-2">
                    <li><a href="cat_area.jsp">猫咪主粮</a></li>
                    <li><a href="riyong_area.jsp">猫咪日用</a></li>
                </ul>
            </div>
            <div>
