...
<head lang="en">
    ...
    <link rel="stylesheet" href="static/css/dog_area.css">
...
<div class="container-fluid px-0">
    ...
    <div class="top_bar  d-lg-block d-none">
        <div class="mx-auto">
            ...
            <div>
                ...
                <a href="goodCar.html"><img src="img/login/gouwuche.svg"></a>
            </div>
        </div>
    </div>
    <!--header内容-->
    ...
    <div class="row d-lg-none d-block" id="menu">
        <ul class="list-unstyled text-center">
            <li class="col-12 active" id="L1">狗狗专区</li>
            <li class="col-12" id="L2"><a href="#">狗狗主粮</a></li>
            <li class="col-12" id="L3"><a href="#">狗狗日用</a></li>
        </ul>
    </div>
    <!--主体内容区域-->
    <div class="dog_area  mx-auto pt-5 row m-0">
        ...
        <div class="main_left col-lg-3 d-lg-block d-none px-0">
            <div>
                <div class="style1"><img src="img/other/y.png"><span>狗狗专区</span></div>
        ...
        <div class="main_right col-lg-9 d-lg-block d-none px-0">
            <div class="row m-0">
                ...
                <div class="col-lg-3  p-0">
                    <a href="#"><img class="w-100" src="img/index/product/dog_pic0101.jpg"  onmouseover="this.src='img/index/product/dog_pic0102.jpg'" onmouseout="this.src='img/index/product/dog_pic0101.jpg'"></a>
        ...
        <div class="my_page">
            <ul class="pagination d-flex" id="page">
                ...
                <li id="page2"><a data-toggle="turn" href="dog_area -page2.jsp">2</a></li>
                <li id="page_next"><a data-toggle="turn" href="dog_area -page2.jsp">下一页</a></li>
            </ul>
        </div>
    </div>
</div>
